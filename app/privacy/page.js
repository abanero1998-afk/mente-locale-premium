    ...
    <main className="service-page">
      ...
      <div className="products-section">
        <article className="product-card liquid-glass" style={{ maxWidth: 800, margin: '0 auto' }}>
          ...
          <p>Mente Locale — email: mentelocale@gmail.com — WhatsApp: +39 344 410 6229.</p>
          ...
          <p>Puoi chiedere accesso, rettifica, cancellazione, limitazione, portabilità e opposizione scrivendo a mentelocale@gmail.com o su WhatsApp.</p>
          <h3 style={{ marginTop: 18 }}>7. Cookie</h3>
          <p>Per i dettagli sui cookie tecnici e di misurazione consulta la <a href="/cookie" style={{ color: '#67e8f9' }}>Cookie Policy</a>.</p>
