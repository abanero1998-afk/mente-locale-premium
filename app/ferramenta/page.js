const WA = 'https://wa.me/393331234567?text=' + encodeURIComponent('Ciao, voglio Negozi Smart — nemmeno una vite persa');
...
const products = [
  {
    title: 'Magazzino Smart IA + barcode',
    desc: 'Inventario automatico. Fotografi il pezzo e il sistema lo trova. Zero viti perse.',
  },
  {
    title: 'Preventivi Smart',
    desc: 'Preventivi in 30 secondi da mobile o WhatsApp. Professionali e immediati.',
  },
  {
    title: 'Sito Catalogo + Click&Collect',
    desc: 'Catalogo online + ritiro in negozio. Vendi anche di notte, consegna in 10 minuti.',
  },
  {
    title: 'Inventory alerts',
    desc: 'Scorta minima e riordini automatici. Non finisci mai i pezzi più venduti.',
  },
  {
    title: 'Lead & WhatsApp automatizzati',
    desc: 'Risposte immediate ai messaggi. Lead qualificati 24/7 senza perdere richieste.',
  },
  {
    title: 'Analytics vendite',
    desc: 'Cosa si vende, cosa resta fermo, trend reali. Decisioni basate sui dati.',
  },
];

const reviews = [
  {
    text: 'Non perdiamo più pezzi. Il magazzino è sotto controllo e i clienti trovano tutto.',
    name: 'Roberto',
    role: 'Ferramenta Centro',
  },
  {
    text: 'Il click&collect ha portato clienti nuovi anche la sera. Il catalogo online funziona.',
    name: 'Elena',
    role: 'Brico Point',
  },
  {
    text: 'I preventivi da WhatsApp ci hanno fatto chiudere lavori che prima perdevamo.',
    name: 'Paolo',
    role: 'Utensileria Pro',
  },
];
    ...
    <main className="service-page service-ferramenta">
      <section className="service-hero">
        ...
        <p className="service-lead">
          Fotografi il pezzo, il sistema lo trova. Magazzino, cassa ed e-commerce parlano. Vendi anche di notte con click & collect.
        </p>
