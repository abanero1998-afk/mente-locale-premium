    ...
    <main className="service-page">
      ...
      <section className="products-section">
        <div className="products-grid">
          <article className="product-card liquid-glass">
            <h3>La storia</h3>
            <p>
              Abbiamo visto troppi titolari passare le serate a inseguire no-show, scorte finite e messaggi WhatsApp senza risposta.
              Così abbiamo costruito pacchetti pronti — non progetti lunghi mesi — pensati per chi lavora sul campo, non per chi sta in riunione.
            </p>
          </article>
          <article className="product-card liquid-glass">
            <h3>Come lavoriamo</h3>
            <p>
              Onboarding in 24 ore. Setup in una settimana. Garanzia 14 giorni soddisfatto o rimborsato, scritta a contratto.
              Parliamo chiaro, senza gergo, e restiamo raggiungibili su WhatsApp quando serve.
            </p>
          </article>
          <article className="product-card liquid-glass">
            <h3>Per chi</h3>
            <p>
              Ristoranti, trattorie, pizzerie. Parrucchieri ed estetisti. Ferramenta e negozi di prossimità.
              Se hai un’attività locale e vuoi più clienti con meno caos, siamo il pezzo che ti manca.
            </p>
          </article>
        </div>
      </section>
      ...
      <section className="service-cta liquid-glass">
        <div>
          ...
          <span>WhatsApp +39 344 410 6229 · mentelocale@gmail.com</span>
        </div>
