const WA = 'https://wa.me/393331234567?text=' + encodeURIComponent('Ciao, voglio Ristorazione Smart — Tavolo Sempre Pieno');
...
const products = [
  {
    title: 'Gestionale Comande',
    desc: 'Comande digitali sincronizzate tra sala e cucina. Zero carta, zero errori, ordine sempre chiaro.',
  },
  {
    title: 'QR Menu Digitale',
    desc: 'Menu interattivo aggiornabile in tempo reale. Allergeni, foto, upselling automatico.',
  },
  {
    title: 'HACCP Pro',
    desc: 'Check-list digitali, alert scadenze e report automatici. Conformità senza stress.',
  },
  {
    title: 'Prenotazioni WhatsApp + IA',
    desc: 'Booking 24/7, reminder automatici e gestione no-show. I tavoli si riempiono da soli.',
  },
  {
    title: 'Sito Web + SEO Locale',
    desc: 'Sito veloce ottimizzato per Google Maps e ricerche locali. Più clienti dal web.',
  },
  {
    title: 'Analytics & Report',
    desc: 'Dashboard coperti, ticket medio e performance reali. Decidi con i numeri, non a sentimento.',
  },
];

const reviews = [
  {
    text: 'In 11 giorni i tavoli del venerdì sono sempre pieni. Zero sbatti con le comande.',
    name: 'Marco',
    role: 'Trattoria del Borgo',
  },
  {
    text: 'Le comande digitali ci hanno tolto 2 ore di lavoro al giorno. La cucina ringrazia.',
    name: 'Laura',
    role: 'Osteria 12',
  },
  {
    text: 'I no-show sono quasi spariti grazie ai reminder WhatsApp. Valeva ogni centesimo.',
    name: 'Andrea',
    role: 'Ristorante Il Giardino',
  },
];
    ...
    <main className="service-page service-ristoranti">
      <section className="service-hero">
        ...
        <p className="service-lead">
          Dal QR al piatto, senza sbatti. Il cliente inquadra, ordina, paga. La cucina riceve la comanda pulita.
          Tu riempi i tavoli e tagli gli errori.
        </p>
