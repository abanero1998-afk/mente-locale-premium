    ...
    <main className="service-page">
      ...
      <div className="products-section">
        <article className="product-card liquid-glass" style={{ maxWidth: 800, margin: '0 auto' }}>
          ...
          <p>Se attivi strumenti di statistica (es. Vercel Analytics o simili), i dati sono usati in forma aggregata per migliorare il sito. Dove richiesto, chiederemo il consenso.</p>
          ...
          <p>Per domande: mentelocale@gmail.com · WhatsApp +39 344 410 6229</p>
